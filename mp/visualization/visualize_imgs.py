...
def ensure_channel_width_height_depth(np_array):
    ...
    if len(np_array.shape) == 4:
        np_array = np_array.transpose(axis_order[0], axis_order[3], axis_order[2], axis_order[1])
    return np_array
...
def visualize_dataloader_with_masks(dataloader, max_nr_imgs=100, save_path=None, img_size=(256, 256), alpha=0.5):
