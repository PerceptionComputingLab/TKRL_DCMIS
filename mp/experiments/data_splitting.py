...
def split_instances(dataset, ratio=0.7, exclude_ixs=[], stratisfied=True, respecting_groups=True):
    ...
    operations prefers to give more examples ofpcderrepresented classes
    ...
    if not stratisfied:
        ...
        ixs_1, ixs_2 = [], []
        class_instances = {
            class_name: dataset.get_class_instance_ixs(class_name=class_name, exclude_ixs=exclude_ixs)
