...
class Agent:
    ...
    def perform_training_epoch(self, optimizer, loss_f, train_dataloader, print_run_loss=False, *args, **kwargs):
    ...
    def train(
        ...
        for epoch in range(init_epoch, init_epoch + nr_epochs):
            ...
            self.perform_training_epoch(optimizer, loss_f, train_dataloader, print_run_loss=print_run_loss)
